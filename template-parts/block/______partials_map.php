...
var Grid = (function() {
	...
	function initItemsEvents( $items ) {
		...
		$items.on( 'click', '.prev', function() {
			jQuery('.og-expanded').prev('li').children('a').click();
		  
			return false;
		} )

		$items.on( 'click', '.next', function() {
			jQuery('.og-expanded').next('li').children('a').click();
			return false;
		} )
	...
	Preview.prototype = {
		create : function() {
			...
			this.$href = jQuery( '<div class="og-controls"><span class="prev"><</span> <span class="curr-index"></span> / <span class="total-items"></span> <span class="next">></span></div>' );
		...
		update : function( $item ) {
			...
			jQuery('.curr-index').html(current + 1);

			jQuery('.total-items').html($items.length);
...
/*
	 ...
	 */
		 ...
		 * It then updates the current scene state accordingly (or does nothing, if the state is already correct) Ã¢â‚¬â€œ Pins will be set to their correct position and tweens will be updated to their correct progress.  
		 ...
		 * @param {mixed} [additionalParameter] - If a custom scroll function was defined (see above 4.), you may want to supply additional parameters to it, when calling it. You can do this using this parameter Ã¢â‚¬â€œ see examples for details. Please note, that this parameter will have no effect, if you use the default scrolling function.
		 * @returns {Controller} Parent object for chaining.
		 */
 ...
 */
	...
	var _util = ScrollMagic._util = (function (window) {
		...
		// extend obj Ã¢â‚¬â€œ same as jQuery.extend({}, objA, objB)
